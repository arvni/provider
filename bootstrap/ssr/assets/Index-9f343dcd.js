...
import AddForm from "./AddForm-aec19eaa.js";
...
const Index = ({ auth, symptoms: { data: symptomsData, ...pagination }, status, request }) => {
  var _a, _b, _c, _d;
  const {
    data,
    processing,
  ...
  const columns = [
    ...
    },
    {
      ...
      filter: {
        ...
        label: "Symptom Name",
        type: "text",
        value: (_b = data == null ? void 0 : data.filter) == null ? void 0 : _b.symptomName
      },
      sortable: true
    },
    {
      ...
      filter: {
        ...
        label: "HPO ID",
        type: "text",
        value: (_c = data == null ? void 0 : data.filter) == null ? void 0 : _c.hpo
      },
      sortable: true
    },
    {
      ...
      filter: {
        ...
        label: "Symptom Group",
        type: "text",
        value: (_d = data == null ? void 0 : data.filter) == null ? void 0 : _d.symptom_group_name
      }
    },
    {
      field: "id",
  ...
  const handleEdit = (id) => () => {
    getData(routes.symptoms.show.link(id)).then(({ data: data2 }) => setSymptom(data2)).then(handleOpenAddForm);
  };
  const handlePage = (e) => {
    e.preventDefault();
    reload();
  };
  return /* @__PURE__ */ jsxs(AdminLayout, { user: auth.user, header: "Symptoms", children: [
    ...
    openAddForm && /* @__PURE__ */ jsx(AddForm, { open: openAddForm, onClose: handleCloseAddForm, defaultValue: symptom }),
