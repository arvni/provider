...
const routes = {
    ...
    orderMaterials: {
        ...
        update: {
            ...
            link: (id:ID) => route("order-materials.update", id),
    ...
    sampleTypes: {
        ...
        update: {
            ...
            link: (id:ID) => route("admin.sample-types.update", id),
        ...
        show: {
            ...
            link: (id:ID) => route("api.sample-types.show", id),
    ...
    symptomGroups: {
        ...
        update: {
            ...
            link: (id:ID) => route("admin.symptom-groups.update", id),
        ...
        show: {
            ...
            link: (id:ID) => route("api.symptom-groups.show", id),
    ...
    symptoms: {
        ...
        update: {
            label: "Edit Symptom",
            link: (id:ID) => route("admin.symptoms.update", id),
        ...
        show: {
            label: " Symptom Show",
            link: (id:ID) => route("api.symptoms.show", id),
    ...
    diseases: {
        ...
        update: {
            label: "Edit Disease",
            link: (id:ID) => route("admin.diseases.update", id),
        ...
        show: {
            label: " Disease Show",
            link: (id:ID) => route("api.diseases.show", id),
    ...
    consents: {
        ...
        update: {
            label: "Edit Consent",
            link: (id:ID) => route("admin.consents.update", id),
        ...
        show: {
            label: " Consent Show",
            link: (id:ID) => route("api.consents.show", id),
    ...
    tests: {
        ...
        edit: {
            label: "Edit Test",
            link: (id:ID) => route("admin.tests.edit", id),
            permission: "Test Edit"
        },
        update: {
            label: "Edit Test",
            link: (id:ID) => route("admin.tests.update", id),
            permission: "Test Edit"
        },
        delete: {
            label: "Delete Test",
            link: (id:ID) => route("admin.tests.destroy", id),
    ...
    orders: {
        ...
        show: {
            label: "Show Order",
            link: (id:ID) => route("orders.show", id),
            permission: "Order Show"
        },
        edit: {
            label: "Edit Package",
            link: (id:ID,step:number) => route("orders.edit", {order:id,step}),
            permission: "Package Edit"
        },
        update: {
            label: "Package Test",
            link: (id:ID,step:number) => route("orders.update", {order:id,step}),
            permission: "Package Edit"
        },
        delete: {
            label: "Package Test",
            link: (id:ID) => route("orders.destroy", id),
            permission: "Package Edit"
        },
        list: {
            label: "Package List",
    ...
    users: {
        ...
        update: {
            label: "Edit User",
            link: (id:ID) => route("admin.users.update", id),
            permission: " User.Edit"
        },
        updatePassword: {
            label: "Edit User",
            link: (id:ID) => route("admin.users.updatePassword", id),
        ...
        show: {
            label: " User Show",
            link: (id:ID) => route("api.users.show", id),
