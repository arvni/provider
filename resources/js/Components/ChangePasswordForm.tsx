...
const ChangePasswordForm = ({
    ...
    const {
        ...
        user?.id ? routes.users.updatePassword.link(user.id) : routes.passwordUpdate.link
    );
    useEffect(() => {
        reset();
    }, []);
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <DialogContent>
                <Box component={"form"} onSubmit={handleSubmit} method={"post"} action={routes.passwordUpdate.link}
                     sx={{pt: "1em"}}>
