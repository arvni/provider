...
interface PatientDetailsFormProps {
    ...
    onChange: (key: keyof Order["patient"], value: any) => void,
    onSubmit: () => void,
    errors: Record<string, string>
}

const PatientDetailsForm = (props: PatientDetailsFormProps) => {
    const handleChange: React.ChangeEventHandler<HTMLTextAreaElement | HTMLInputElement> & ((event: SelectChangeEvent<any>, child: React.ReactNode) => void) = (e) => {

        props.onChange(e.target.name as keyof Order["patient"], e.target.value);
    }
    const handleContactChange: React.ChangeEventHandler<HTMLTextAreaElement | HTMLInputElement> & ((event: SelectChangeEvent<any>, child: React.ReactNode) => void) = (e) => {
    ...
    const handleNationalityChange = (e: React.SyntheticEvent<Element, Event>, value: Country | null) => {
        props.onChange("nationality", value);
    }
    const handleContactCountryChange = (e: React.SyntheticEvent<Element, Event>, value: Country | null) => {
        let contact = {
    ...
    const handlePhoneCountryCodeChange = (phone: string) => props.onChange("contact", {
        ...props.patient,
